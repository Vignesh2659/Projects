...
### If a ticker can’t be resolved, add entries to the STATIC_TICKERS map in resolve_ticker.

### yfinance news payloads can vary; format_headlines_block already normalizes fields to avoid .strip()-type errors.
